...
Invoke-Adb -Arguments @('install', '-r', (Join-Path $repoRoot 'app/build/outputs/apk/debug/app-debug.apk'))
Invoke-Adb -Arguments @('install', '-r', (Join-Path $repoRoot 'app/build/outputs/apk/androidTest/debug/app-debug-androidTest.apk'))
